...
def fallback_question(
    probe_level: ProbeLevel, claim_text: str | None = None
) -> GeneratedQuestion:
...
async def generate_question(
    ...
    *,
    ...
    prompt = load_prompt(
        ...
        probe_level_brief=PROBE_BRIEFS[probe_level],
    ...
    result = await complete_json(
        ...
        fallback=lambda: fallback_question(probe_level, claim_text),
    ...
    if len(text) < 12:
        ...
        return fallback_question(probe_level, claim_text)
